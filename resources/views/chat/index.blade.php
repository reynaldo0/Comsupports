...
<head>
    ...
    <style>
        /* ── Palet Warna Brand (konsisten dengan admin) ───────── */
        :root {
            --blue-600: #2563EB;
            /* warna utama aksi      */
            --indigo-600: #4F46E5;
        ...
        .message {
            animation: fade-in-up .35s cubic-bezier(.16, 1, .3, 1) both;
        }
...
<body class="antialiased">
    <div class="flex min-h-screen items-center justify-center bg-slate-100 p-4 sm:p-6">
        ...
        {{-- Chat Window --}}
        <div
            class="flex h-[85vh] max-h-[820px] min-h-[540px] w-full max-w-2xl flex-col overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm">
            ...
            <header class="flex items-center justify-between border-b border-gray-100 px-5 py-4 sm:px-6">
                <div class="flex items-center gap-3">
                    <div class="relative">
                        <div
                            class="flex h-11 w-11 items-center justify-center rounded-xl bg-blue-600 shadow-md shadow-blue-500/30">
            ...
            {{-- Chat Area --}}
            <div id="chat-box"
                class="chat-scroll flex-1 space-y-4 overflow-y-auto scroll-smooth bg-gray-50 px-4 py-6 sm:px-6">
                <div class="message flex items-end gap-2.5">
                    <div
                        class="flex h-8 w-8 shrink-0 items-center justify-center rounded-xl bg-blue-600 text-white shadow-md shadow-blue-500/30">
                    ...
                    <div
                        class="max-w-[78%] rounded-2xl rounded-bl-md bg-gray-100 px-4 py-3 text-sm leading-relaxed text-gray-800 shadow-sm">
                        Halo! Saya <strong class="font-semibold text-gray-900">Comsupport AI</strong>. Tanyakan apapun
                        seputar layanan kami, atau pilih pertanyaan cepat di bawah ini.
                    </div>
                </div>
                ...
                <div id="quick-suggestions" class="flex flex-wrap gap-2 pl-10">
                    <button type="button" data-question="Bagaimana cara melakukan pemesanan?"
                        ...
                        <svg class="h-3.5 w-3.5 text-indigo-500" fill="currentColor" viewBox="0 0 20 20">
                            <path
                                d="M9 1.5a1 1 0 011.7-.7l6.5 6.5a1 1 0 01-.7 1.7H13v8a1 1 0 01-1 1H8a1 1 0 01-1-1V9H3.5a1 1 0 01-.7-1.7l6.5-6.5A1 1 0 019 1.5z" />
                        </svg>
                    ...
                    <button type="button" data-question="Metode pembayaran apa saja yang tersedia?"
                        ...
                        <svg class="h-3.5 w-3.5 text-indigo-500" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <path fill-rule="evenodd"
                                d="M18 9H2v5a2 2 0 002 2h12a2 2 0 002-2V9zM4 12a1 1 0 011-1h1a1 1 0 110 2H5a1 1 0 01-1-1z"
                                clip-rule="evenodd" />
                        </svg>
                        Metode pembayaran?
                    </button>
            ...
            <div class="border-t border-gray-100 bg-white px-4 py-4 sm:px-6">
                <div class="flex items-center gap-2">
                    <input type="text" id="user-input" placeholder="Ketik pertanyaanmu di sini..."
                ...
                <p class="mt-2.5 text-center text-[11px] text-gray-400">Comsupport AI menjawab berdasarkan knowledge
                    base FAQ kami.</p>
            </div>
        </div>
    </div>
